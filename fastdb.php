...
/*
	FastDB 1.0
	Developed by: NexonSoft
*/

ob_start('ob_gzhandler');

// Some of the features in the SQL editor require creating 'fastdb' directory,
...
if (!defined('FASTDB_DIR')) {
	define('FASTDB_DIR', 'fastdb');
}
...
/*
	...
	define('FASTDB_DIR', 'fastdb_mysql');
...
if (isset($_GET['fastdb_favicon'])) {
	$favicon = '';
...
if (!$db_pass || (!$db_driver || !$db_server || !$db_name || !$db_user))
{
	...
	?>
		...
		<head>
			...
			<title>Connect</title>
			<link rel="shortcut icon" href="<?php echo $_SERVER['PHP_SELF']; ?>?fastdb_favicon=1">
		</head>
		<body>
	...
	foreach($text as $key => $value)
	{
		...
		if(!$result) {
			...
			if (!$ignore_errors) {
				...
				echo '<br><div><a class="transition" href="'.$_SERVER['PHP_SELF'].'?import=1">&lt;&lt; go back</a></div>';
				exit;
			}
		}
	}
...
function layout()
{
	...
	?>
		<style>
		body,table,input,select,textarea { font-family: "Droid Sans", "Helvetica Neue", Helvetica, Arial, sans-serif; font-size: 13px; }
		body{margin:0; padding:0; margin-top:0.5em; background:#161616; color:#cbcdcd; padding-bottom:20px; font-size:12px}
		body { display: none; }
		h1, h2 { font-family: "Droid Sans", "Helvetica Neue", Helvetica, Arial, sans-serif; margin: 1em 0; }
		h1 { font-size: 150%; margin: 0.7em 0; }
		h2 { font-size: 125%; }
		.ls {width: 950px;}
		.ls th { background: #111111;}
		.ls th th { background-color: none; }
		.ls td { background: #161616; }
		.ls td td { background-color: none; }
		.ls th, .ls td { padding: 3px 5px; }
		.ls th th, .ls td td { padding: 0; }
		.ls2 th { text-align: left; vertical-align: top; line-height: 1.7em; background: #111111; font-weight: normal; }
		...
		a, a.blue { color: #ffa800; }
		a:visited { color: #ffa800; }
		a.blue:visited { color: #ffa800; }
		...
		input, textarea, select, .sql_area{background:#1a1a1a; border:1px solid #333; padding:6px 10px; outline:none; color:#fff}
		button, .button{font-size:12px; font-weight:bold; color:#fff; padding:6px 10px; margin-right:5px; width:auto !important; border:1px solid #333; background:#161616}
		#content-wrapper{margin:0 auto; width:956px; position:relative}
		.content{background:#252525; border:1px solid #161616}
		.modal-overlay{position:fixed; top:0; right:0; bottom:0; left:0; height:100%; width:100%; margin:0; padding:0; background:#000; opacity:.85; filter:alpha(opacity=75); -moz-opacity:0.75; z-index:101}
		...
		* html .modal-window{position:absolute}
		.close-window{position:absolute; width:32px; height:32px; right:8px; top:8px; background:transparent url('/examples/modal-simple/close-button.png') no-repeat scroll right top; text-indent:-99999px; overflow:hidden; cursor:pointer; opacity:.5; filter:alpha(opacity=50); -moz-opacity:0.5}
...
var modalWindow = {
	...
	var openMyModal = function(source)
	{
		...
		modalWindow.content = "<iframe width='980' height='640' frameborder='0' scrolling='auto' allowtransparency='true' src='" + source + "'>&lt/iframe>";
		modalWindow.open();
	};	
		</script>
	<?php
...
function conn_info()
{
	...
	<p>
		...
		( open in <a href="<?php echo $_SERVER['PHP_SELF'];?>?execute_sql=1&popup=1" onclick="openMyModal('<?php echo $_SERVER['PHP_SELF'];?>?execute_sql=1&popup=1'); return false;">Modal Window</a> )
		<br />
...
function powered_by()
{
	?>
		...
		function link_noreferer(link)
		{
			...
			w.document.write("<br>The site you are being redirected will not know the location of the fastdb script on your site.<"+"/p>");
		...
		<div style="text-align: center; margin-top: 2em; border-top: #111111 1px solid; padding-top: 0.5em;">powered by <a href="javascript:void(0)" onclick="link_noreferer('http://www.yourwebsite.com/')">yourwebsite.com</a></div>
	<?php
}
...
<?php if (get('import')): ?>
	...
	<?php layout(); ?>
	<h1><a class="transition" class=blue style="<?php echo $db_name_style;?>" href="<?php echo $_SERVER['PHP_SELF'];?>"><?php echo $db_name_h1?$db_name_h1:$db_name;?></a> &gt; Import</h1>
	<?php conn_info(); ?>
...
<?php
	...
	if (!fastdb_filter_id($get['table'])) {
		error('Invalid table name');
	}
	if (!fastdb_filter_id($get['pk'])) {
		error('Invalid pk');
	}
	...
	$edit_action = post('fastdb_action');
...
<?php layout_start($title_edit); ?>
	...
	<?php if ($row): ?>
		...
		<?php echo radio_assoc($edit_action, $edit_actions_assoc, 'fastdb_action');?></td>
		<br>
...
?>
	<?php if (is_numeric($found)): ?>
		<p>
			...
			?>
			/ <a class="transition" href="<?php echo url(self(), $params);?>">Refetch</a>
			/ Export to CSV:&nbsp;
			
			<a class="transition" href="<?php echo $_SERVER['PHP_SELF']; ?>?export=csv&separator=<?php echo urlencode('|');?>&query=<?php echo base64_encode($base_query); ?>">pipe</a>
			-
			<a class="transition" href="<?php echo $_SERVER['PHP_SELF']; ?>?export=csv&separator=<?php echo urlencode("\t");?>&query=<?php echo base64_encode($base_query); ?>">tab</a>
			-
			<a class="transition" href="<?php echo $_SERVER['PHP_SELF']; ?>?export=csv&separator=<?php echo urlencode(',');?>&query=<?php echo base64_encode($base_query); ?>">comma</a>
			-
			<a class="transition" href="<?php echo $_SERVER['PHP_SELF']; ?>?export=csv&separator=<?php echo urlencode(';');?>&query=<?php echo base64_encode($base_query); ?>">semicolon</a>
		</p>
	<?php else: ?>
	...
	<?php if (is_numeric($found)): ?>
		...
		<p>
			<?php if ($page > 1): ?>
				...
				<?php
					...
					if (get('only_select') || post('only_select')) { $params['only_select'] = 1; }
				?>
				<a class="transition" href="<?php echo url(self(), $params);?>">&lt;&lt; Prev</a> &nbsp;
			<?php endif; ?>
			...
			<?php if ($pages > $page): ?>
				...
				<?php
					...
					if (get('only_select') || post('only_select')) { $params['only_select'] = 1; }
				?>
				<a class="transition" href="<?php echo url(self(), $params);?>">Next &gt;&gt;</a>
			<?php endif; ?>
		</p>
		<?php endif; ?>
		...
		<?php if ($found): ?>
			...
			<tr ondblclick="mark_row(this)">
				<?php if ($edit_url): ?>
					<td><a href="<?php echo sprintf($edit_url, $row[$edit_pk]);?>" onclick="openMyModal('<?php echo sprintf($edit_url, $row[$edit_pk]);?>'); return false;">Edit</a>&nbsp;</td>
				<?php endif; ?>
				<?php
					$count_cols = 0;
...
<?php layout_start(($db_name_h1?$db_name_h1:$db_name).' &gt; Execute SQL'); ?>
	...
	<?php else: ?>
		<h1><a class="transition" style="<?php echo $db_name_style;?>" href="<?php echo $_SERVER['PHP_SELF'];?>"><?php echo $db_name_h1?$db_name_h1:$db_name;?></a> &gt; Execute SQL</h1>
	<?php endif; ?>
...
<div class="content">
	...
	<h1><a class="transition" style="<?php echo $db_name_style;?>" href="<?php echo $_SERVER['PHP_SELF'];?>"><?php echo $db_name_h1?$db_name_h1:$db_name;?></a> &gt; Table: <?php echo $table;?></h1>

	<?php conn_info(); ?>

	<p>
		<a class="transition" href="<?php echo $_SERVER['PHP_SELF'];?>">All tables</a>
		&nbsp;&gt;&nbsp;
		<a class="transition" href="<?php echo $_SERVER['PHP_SELF'];?>?viewtable=<?php echo $table;?>"><b><?php echo $table;?></b></a> (<?php echo $count;?>)
		&nbsp;&nbsp;/&nbsp;&nbsp;
		...
		&nbsp;&nbsp;/&nbsp;&nbsp;
		Functions:
		<a class="transition" href="<?php echo $_SERVER['PHP_SELF'];?>?viewtable=<?php echo $table;?>&indenthead=1">indenthead()</a>
	</p>
	...
	<?php if ($count): ?>
		...
		<?php if ($found): ?>
			...
			<p>
				<?php if ($page > 1): ?>
					<a class="transition" href="<?php echo url_offset(($page-1)*$limit-$limit);?>">&lt;&lt; Prev</a> &nbsp;
				<?php endif; ?>
				Page <b><?php echo $page;?></b> of <b><?php echo $pages;?></b> &nbsp;
				<?php if ($pages > $page): ?>
					<a class="transition" href="<?php echo url_offset($page*$limit);?>">Next &gt;&gt;</a>
				<?php endif; ?>
			</p>
			<?php endif; ?>
			...
			<tr>
				...
				<?php foreach ($columns as $col): ?>
					...
					?>
					<th><a href="<?php echo url(self(), $params);?>"><?php echo $col;?></a></th>
				<?php endforeach; ?>
			</tr>
			<?php
			...
			<tr ondblclick="mark_row(this)">
				<?php if ($pk): ?>
					...
					<td><a href="<?php echo $edit_url;?>" onclick="openMyModal('<?php echo $edit_url;?>'); return false;">Edit</a>&nbsp;</td>
				<?php endif; ?>
				<?php foreach ($row as $k => $v): ?>
					<?php
						$v = strip_tags($v);
...
<?php layout_start(sprintf('%s &gt; Search', $db_name)); ?>
	<h1><a class="transition" style="<?php echo $db_name_style;?>" href="<?php echo $_SERVER['PHP_SELF'];?>"><?php echo $db_name_h1?$db_name_h1:$db_name;?></a> &gt; Search</h1>
	<?php conn_info(); ?>
	...
	<?php if ($get['search'] && count($get['types'])): ?>
		...
		<?php foreach ($tables as $table): ?>
			...
			<?php if ($where && $found): ?>
				...
				<p>
					Table: <a class="transition" href="<?php echo $_SERVER['PHP_SELF'];?>?viewtable=<?php echo $table;?>&search=<?php echo urlencode($get['search']);?>"><b><?php echo $table;?></b></a><br>
					Found: <b><?php echo $found;?></b>
					<?php if ($found > $limit): ?>
						&nbsp;<a class="transition" href="<?php echo $_SERVER['PHP_SELF'];?>?viewtable=<?php echo $table;?>&search=<?php echo urlencode($get['search']);?>">show all &gt;&gt;</a>
					<?php endif; ?>
				</p>
...
<div class="box">
	...
	<?php foreach ($tables as $table): ?>
	<tr>
		<td><a class="transition" href="<?php echo $_SERVER['PHP_SELF'];?>?viewtable=<?php echo $table;?>"><?php echo $table;?></a></td>
		<?php
			if ('mysql' == $db_driver) {
				// $table_enq = quote_table($table);
				// $count = db_one("SELECT COUNT(*) FROM $table_enq");
...
<div style="float: left; margin-left: 2em;">
	...
	<tr>
		<td><a class="transition" href="<?php echo $_SERVER['PHP_SELF'];?>?viewtable=<?php echo $view;?>"><?php echo $view;?></a></td>
		<?php
